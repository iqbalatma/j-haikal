               ...
               <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-horizontal" action="{{ route('suplier.update', $suplier->id) }}"
                                method="POST">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="nama_suplier" name="nama_suplier" class="form-control @error('nama_suplier') is invalid @enderror"
                                                value="{{ old('nama_suplier') ?? $suplier->nama_suplier}}"  placeholder="Nama Supplier">
                                             @error('nama_suplier')
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="alamat" name="alamat" class="form-control @error('alamat') is invalid @enderror"
                                                value="{{ old('alamat') ?? $suplier->alamat}}" placeholder="Alamat">
                                             @error('alamat')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                             @enderror
                                        </div>
